...
####Code is awaiting publication. Do not distribute this code. 
...
if lower == 'n':
    while True:
        ...
        if a == "2":
            ...
            if savyn.lower() == "y":
                window = int(raw_input("Please enter the window width, must be an odd integer greater than or equal to 3: "))
