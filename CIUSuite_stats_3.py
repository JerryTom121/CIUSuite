...
if lower == 'n':
    while True:
        ...
        if a == "2":
            ...
            if savyn.lower() == "y":
                window = input("Please enter the window width, must be an odd integer greater than or equal to 3: ")
                assert window % 2 != 0, "You must enter an odd integer"
                continue
        if a == "3":
                titleav = input("Please enter title for the average plot: ")
                titlestd = input("Please enter title for the standard deviation plot: ")
                titlex = input("Please title your X axis: ") #For our lab normally Trap Collision Energy
